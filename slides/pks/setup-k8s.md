...
- We used Pivotal Container Service (PKS) a multicloud Kubernetes broker.

- But first we Created a GKE Kubernetes cluster
  - We installed the Google Cloud Operator on GKE
  - We installed PKS using the GCP Operator
  - We installed this Kubernetes cluster using PKS

---

# Setting up Kubernetes

- How can I set up a basic Kubernetes lab at home?

--

<!-- ##VERSION## -->

- Run `kubeadm` on freshly installed VM instances running Ubuntu LTS
